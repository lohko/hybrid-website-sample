                  ...
                  <div className="text-white  align-items-center rgba-black-strong py-5  rounded">
                    <div>
                      <h3 className="py-3 font-weight-bold">
                        <strong>Projekti 1</strong>
                      </h3>
                      <p className="pb-3">
                        Tässä voit esitellä esimerkiksi yrityksesi tekemiä
                        projekteja, saavutuksia tai vaikka suosituksia muilta
                        yrityksiltä.
                      </p>
                ...
                >
                  <div className="text-white text-center d-flex align-items-center rgba-black-strong py-5 px-4 rounded">
                    <div>
                      ...
                      <MDBBtn color="dark" rounded size="md">
                        <MDBIcon far icon="clone" className="left" /> Näytä
                        lisää
                      </MDBBtn>
                    </div>
                  </div>
